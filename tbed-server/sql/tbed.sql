...
) ENGINE = InnoDB AUTO_INCREMENT = 2109218818 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = COMPRESSED;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'YWRtaW4=', 'admin', '2019-01-10', 2, '62d9eff7d6a8458497886726335ebb31', 1, '2147483648', 1);
